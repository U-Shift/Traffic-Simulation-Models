...
![](images/clipboard-2902263528.png)
...
To keep only the POIs relative to your city limit, you can make a geometrical filtering, as:

```{r}
points_poi = points_poi[city_limit,]
```

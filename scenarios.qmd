...
2.  Create a new scenario, and import an existing subway gtfs (`.zip`) - **max 50 lines**![^1]
...
[^1]: Tip: you may need to filter by a mode (tram, or subway) to avoid having more than 50 lines.
...
```{r}
#| code-fold: true
#| code-summary: "Code example to filter a gtfs by mode"

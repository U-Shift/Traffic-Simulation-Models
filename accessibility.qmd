...
We can also do for **population** with PTransit (1 transfer, peak hour)
...
Read [Chapter 3](https://ipeagit.github.io/intro_access_book/3_calculando_acesso.en.html) from @accessibility for other acessibility estimates.

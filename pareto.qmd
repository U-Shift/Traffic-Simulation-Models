...
In this example, we calculate the Pareto frontier from all origins to downtown considering multiple cutoffs of monetary costs:
...
-   €3.50, which would allow for walking walking + bus + subway
...
![](images/clipboard-3634180098.png){fig-align="center" width="599"}
...
![](images/clipboard-1392517926.png){fig-align="center" width="408"}

![](images/clipboard-1743970520.png){fig-align="center" width="532"}
...
![With hex grid](images/clipboard-2680957931.png){alt="With hex grid" fig-align="center"}

![With census units](images/clipboard-2837442883.png){alt="With census units" fig-align="center"}

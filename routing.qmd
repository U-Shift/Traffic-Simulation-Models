...
```{r}
AREAS = st_read("data/Lisbon/CENSUS_POIs_Lx.gpkg")
AREAS_df = AREAS_counts |> st_drop_geometry()
```
...
# bring geometry
access = access |> left_join(AREAS_counts, by = "id")
...
![](images/clipboard-2837442883.png)

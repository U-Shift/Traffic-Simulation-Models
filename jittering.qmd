...
# Lisbon limit, for map purpose
lisbon_limit = st_read("https://github.com/U-Shift/Traffic-Simulation-Models/releases/download/2025/Lisboa_lim.gpkg")
```
...
The same but with [Rust](https://github.com/dabreegster/odjitter), wich is faster:
